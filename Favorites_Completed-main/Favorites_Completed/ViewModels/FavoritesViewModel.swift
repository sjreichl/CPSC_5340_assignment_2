...
class FavoritesViewModel : ObservableObject {
    ...
    func favoriteCities() -> [CityModel] {
        cityManager.favoriteItems(items: cities)
    }
    ...
    func favoriteHobbies() -> [HobbyModel] {
        hobbyManager.favoriteItems(items: hobbies)
    }
    ...
    func favoriteBooks() -> [BookModel] {
        bookManager.favoriteItems(items: books)
    }
